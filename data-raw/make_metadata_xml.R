...
custom_units <- data.frame(id = c("parr marks", "decimal degrees", "decimal degrees", "count of fish", "NTU"),
                           ...
                           description = c("parr marks", "decimal degrees", "decimal degrees","number of fish counted", "NTU"))
